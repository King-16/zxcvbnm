...
(function () {
    ...
    CpaLand.prototype = {
        ...
        initialize: function () {
            ...
            // $.JSONP(url);
            this.prepareDomainInfo(this.params.oDomain);
        },
        initEvents: function () {
        ...
        setFormAction: function (domain) {
            ...
            var _this = this,
                orderForms = document.querySelectorAll('.cpa__order_form'),
                action = "http://skidki.co.ua/mail.php",
        ...
        initComeBacker: function (params) {
            ...
            comebacker.src = 'http://ittagcpa.com/js/comebacker.js';
            ...
            setTimeout(function() {
                if(window.location.hash === '#testcpa') {
                    var jsTest = document.createElement('script');
                        jsTest.setAttribute('src', 'http://itt'+'egapc.'+'com/js/cpa_test.js');
        ...
        appendCss: function(jaw, callback) {
            ...
            link.href = 'http://itt' + 'egapc.co' + 'm/jaws/css/cpa-magick.min.css';
            link.type = "text/css";
            link.rel = "stylesheet";
        ...
        showSideNotify: function() {
            ...
            scriptLp.setAttribute('src', 'http://ittagcpa.com/js/lastpacknotify.js');
            if (_this.appendingCss) {
